...
private:
	...
	QPixmap getPrevTrajPixmap(bool& o_PathIdChanged, QPoint& o_Position = QPoint() ) const;
...
private:
	...
	//bie¿¹ca nazwa wyœwietlanej trajektorii
	...
	*/
	...
	//graficzny item, na którym rysujemy poprzedni zazanczony punkt wraz z danym obiektem
