...
/**************************************** GRAPHICS SCENE *****************************/
EditorPropertyScene::EditorPropertyScene(QGraphicsView* view, QObject *parent)
...
EditorPropertyScene::~EditorPropertyScene(){
}

void EditorPropertyScene::refresh(const EditorActionPtr& selectedAction /*= nullptr*/)
{
	//clear scene
	clear();
	m_Action.reset();
...
void EditorPropertyScene::onMessage(EditorMessageType i_Message, int i_ExtraParam /*= -1*/) {
	QGraphicsScene::update();
}
 

void EditorPropertyScene::drawForeground(QPainter *painter, const QRectF &rect)
{
...
void EditorPropertyScene::onSelectionChanged()
{
...
void EditorPropertyScene::mouseDoubleClickEvent(QGraphicsSceneMouseEvent *event)
{
...
void EditorPropertyScene::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
	if (QApplication::keyboardModifiers().testFlag(Qt::ControlModifier))
		return;
...
/**************************************** GRAPHICS ACTION *****************************/
EditorPropertyScene::GraphicsAction::GraphicsAction(QGraphicsItem* parent /*= 0*/)
...
void EditorPropertyScene::GraphicsAction::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget /*= 0*/)
{
