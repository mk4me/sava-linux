	...
	, m_CurrentAction(nullptr)
{
	...
	m_Scene = new EditorPropertyScene(ui.graphicsView, this);
...
/*--------------------------------------------------------------------*/
void EditorPropertyWidget::onSplitClicked()
{
	if (m_CurrentCluster)
	{	
...
/*--------------------------------------------------------------------*/
void EditorPropertyWidget::onDeleteClicked()
{
...
/*--------------------------------------------------------------------*/
void EditorPropertyWidget::onBeginClicked()
{
	if (m_CurrentCluster && m_CurrentAction)
	{
		size_t frame_nr = EditorTimeline::getInstance().getCurrentFrame();
...
/*--------------------------------------------------------------------*/
void EditorPropertyWidget::onEndClicked()
{
	if (m_CurrentCluster && m_CurrentAction)
	{
		size_t frame_nr = EditorTimeline::getInstance().getCurrentFrame();
...
/*--------------------------------------------------------------------*/
void EditorPropertyWidget::onSceneActionChanged()
{
...
/*--------------------------------------------------------------------*/
void EditorPropertyWidget::updateClusterGui()
{
	if (m_CurrentCluster)
	{
...
/*--------------------------------------------------------------------*/
void EditorPropertyWidget::clearClusterGui()
{
...
void EditorPropertyWidget::resizeEvent(QResizeEvent *e)
{
	m_Scene->refresh();
