...
std::string EditorMessageManager::getMessageName(EditorMessageType i_Message)
{
	switch (i_Message)
	{
		...
		case MESSAGE_NEW_SEQUENCE_LOAD_START: return "MESSAGE_NEW_SEQUENCE_LOAD_START";
		case MESSAGE_NEW_SEQUENCE_LOAD_FINISH: return "MESSAGE_NEW_SEQUENCE_LOAD_FINISH";
		case MESSAGE_SCENE_UPDATE: return "MESSAGE_SCENE_UPDATE";
		...
		case MESSAGE_ADD_ACTION: return "MESSAGE_ADD_ACTION";
